...
public class JavaScriptUtil {
	...
	public void generateAlertByJS(String message) throws InterruptedException {
		JavascriptExecutor js = (JavascriptExecutor)driver;
	...
	//back,forward and refresh : "history.go[]" n=0-refresh , n=1-forward , n=-1-backward
	...
	public void goToSpecificPageByJS(String pageNumber) {
		JavascriptExecutor js = (JavascriptExecutor)driver;
		 js.executeScript("history.go('"+pageNumber+"')");
	}
	
	public String getInnerPageTextByJS() {
		JavascriptExecutor js = (JavascriptExecutor)driver;
