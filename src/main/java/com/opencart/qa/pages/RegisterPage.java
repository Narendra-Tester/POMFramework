...
public class RegisterPage {
	...
	private final By subcribeYes = By.xpath("(//label[@class='radio-inline'])[position()=1]/input[@type='radio']");
	private final By subcribeNo = By.xpath("(//label[@class='radio-inline'])[position()=2]/input[@type='radio']");
	...
	public boolean userRegistration(String firstName, String lastName,String telephone, String password, String subcribe) {
		...
		if(eleUtil.waitForElementVisible(successmsg, AppConstants.MEDIUM_TIME_OUT).getText().contains(AppConstants.REGISTER_SUCCESS_MESSG)) {
